...
let mGBASources: [String] = [
	...
	//                "mGBA/src/platform/opengl/gles2.c",
...
let package = Package(
	...
	dependencies: [
		//      .package(url: "https://github.com/JoeMatt/DeltaCore.git", .branch("main"))
...
//				.define("BUILD_GLES3", to: "1")
			]
		),
		.target(
			name: "mGBA",
			exclude: mGBAExcludes,
			sources: mGBASources,
...
//				.define("BUILD_GLES3", to: "1"),
			...
			linkerSettings: [
				.linkedFramework("OpenGLES", .when(platforms: [.iOS, .macCatalyst, .tvOS])),
